...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"miniprogram_music","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 129:
/*!****************************************************************************************************************************************!*\
  !*** C:/Users/liaoruikang/Desktop/wangyiyun/miniprogram_music/uni_modules/uni-transition/components/uni-transition/createAnimation.js ***!
  \****************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 获取轮播图列表
var getBannerApi = function getBannerApi(type) {
  type = type ? type : 1;
...
// 获取排行榜列表
exports.getBannerApi = getBannerApi;var getTopApi = function getTopApi() {
  return _request.default.get('/toplist');
};
// 获取歌单详情
exports.getTopApi = getTopApi;var getPlayListDetailApi = function getPlayListDetailApi(id, s) {
...
// 登录
exports.getCodeList = getCodeList;var loginApi = function loginApi(phone, password, countrycode) {
  var timestamp = new Date().getTime();
  return _request.default.post('/login/cellphone', {
    phone: phone,
    password: password,
...
// 登录状态
exports.loginApi = loginApi;var loginStatusApi = function loginStatusApi() {
  var timestamp = new Date().getTime();
  var cookie = encodeURIComponent(_index.default.state.cookie);
  return _request.default.get('/login/status', {
    cookie: cookie,
    timestamp: timestamp });
...
// 退出登录
exports.loginStatusApi = loginStatusApi;var logoutApi = function logoutApi() {
  var timestamp = new Date().getTime();
  var cookie = encodeURIComponent(_index.default.state.cookie);
...
// 获取热门搜索列表
exports.commentLikeApi = commentLikeApi;var getSearchHotApi = function getSearchHotApi() {
  return _request.default.get('/search/hot/detail');
};

// 获取搜索建议
exports.getSearchHotApi = getSearchHotApi;var getSearchSuggestApi = function getSearchSuggestApi(keywords, type) {
  return _request.default.get('/search/suggest', {
    keywords: keywords,
    type: type },
  false);
};
...
// 搜索
exports.getSearchSuggestApi = getSearchSuggestApi;var getSearchApi = function getSearchApi(keywords, limit, type) {
  var cookie = encodeURIComponent(_index.default.state.cookie);
  return _request.default.get('/cloudsearch', {
    keywords: keywords,
    limit: limit,
    type: type,
    cookie: cookie },
...
/***/ 14:
/*!***********************************************************************************!*\
  !*** C:/Users/liaoruikang/Desktop/wangyiyun/miniprogram_music/request/request.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function $http(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
  uni.showLoading({
    title: '加载中...' });
...
$http.get = function (url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var isMsg = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  if (isMsg) {
    uni.showLoading({
      title: '加载中...' });
...
$http.post = function (url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  uni.showLoading({
    title: '加载中...' });
...
/***/ 15:
/*!**********************************************************************************!*\
  !*** C:/Users/liaoruikang/Desktop/wangyiyun/miniprogram_music/request/config.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  baseURL: 'https://www.codeman.ink/api' };exports.default = _default;

/***/ }),

/***/ 16:
/*!*******************************************************************************!*\
  !*** C:/Users/liaoruikang/Desktop/wangyiyun/miniprogram_music/store/index.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: {
    // 更新设备信息
    updateSystemInfo: function updateSystemInfo(state, val) {
      state.systemInfo = val;
    },
    updateCodeList: function updateCodeList(state, val) {
      state.codeList = val;
    },
    updateCookie: function updateCookie(state, val) {
      state.cookie = val;
      this.commit('saveStorageCookie');
    },
    saveStorageCookie: function saveStorageCookie(state) {
      uni.setStorageSync('cookie', state.cookie);
    },
    updateUserData: function updateUserData(state, val) {
      state.userData = val;
...
/***/ 5:
/*!***************************************************************************!*\
  !*** C:/Users/liaoruikang/Desktop/wangyiyun/miniprogram_music/pages.json ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 72:
/*!********************************************************************************************************************!*\
  !*** C:/Users/liaoruikang/Desktop/wangyiyun/miniprogram_music/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
